                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Nama Petugas</th>
            ...
            <form method="POST" action="{{ route('petugas.store') }}">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" placeholder="Contoh: Fahmi Nuradi" required />
                    </div>
                    <div>
                        <x-input-label for="email" value="Email" />
                        <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" placeholder="Contoh: fahmi@idn.com" required />
                    </div>
                </div>
