                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <td class="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400">{{ $item->name }}</td>
                                <td class="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400">{{ $item->email }}</td>
                                <td>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                            placeholder="Contoh: fahmi@idn.com" required />
                    </div>
                </div>
