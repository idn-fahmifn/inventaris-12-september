                ...
                <div class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div class="flex flex-col justify-center">
                            <div>
                                <h1 class="text-xl lg:text-xl font-bold text-gray-900 dark:text-gray-100">
                                    {{ $data->nama_ruangan }}
                                </h1>
                                ...
                                <p class="text-md text-gray-900 dark:text-gray-400 mt-2">
                                    Penanggung Jawab : <span class="font-bold">{{ $data->pic->name }}</span>
                                </p>
                                <p class="text-md text-gray-900 dark:text-gray-400 mt-2">
                                    Ukuran :
                                    ...
                                    @switch($data->ukuran)
                                        ...
                                        @default
                                            <span class="text-orange-500">Ruangan 2x Besar</span>
                                    @endswitch
                                </p>
        ...
        <form method="post" action="{{ route('ruangan.update', $data->id) }}" class="p-6">
            ...
            <div>
                ...
                <select name="id_user" required
                    ...
                    id="">
                    <option value="{{ $data->id_user }}">{{ $data->pic->name }}</option>
